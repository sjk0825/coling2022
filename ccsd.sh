...
output_dir=./model_ccsd_30/$lang
train_file=$data_dir/train
dev_file=$data_dir/valid
eval_steps=1000 #400 for ruby, 600 for javascript, 1000 for others
train_steps=80000 #20000 for ruby, 30000 for javascript, 50000 for others
...
test_node_idx=$npy_dir/test_mask.npy
test_node_len=$npy_dir/test_node_len.npy
test_node_edge=$npy_dir/test_edge.npy
