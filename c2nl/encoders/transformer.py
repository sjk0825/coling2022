...
class TransformerEncoder(EncoderBase):
    ...
    Returns:
        ...
        * memory_bank `[src_len x sh jikyeong.son@165.132.142.82 atch_size x model_dim]`
    """
    ...
    def forward(self, src, node_edge=None, lengths=None, adjacency=None):
        """
        Args:
